...
pub const reg_dispstat: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0004);

/// REG_VCOUNT. See `gba.display.vcount`.
pub const reg_vcount: *volatile u16 = @ptrFromInt(io_address + 0x0006);

/// REG_BGCNT. See `gba.display.bg_ctrl`.
pub const reg_bgcnt: *align(4) volatile [4]u16 = @ptrFromInt(io_address + 0x0008);

/// REG_BG0CNT. See `gba.display.bg_ctrl` and, more specifically,
/// `gba.display.bg_ctrl[0]`.
pub const reg_bg0cnt: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0008);

/// REG_BG1CNT. See `gba.display.bg_ctrl` and, more specifically,
/// `gba.display.bg_ctrl[1]`.
pub const reg_bg1cnt: *volatile u16 = @ptrFromInt(io_address + 0x000a);

/// REG_BG2CNT. See `gba.display.bg_ctrl` and, more specifically,
/// `gba.display.bg_ctrl[2]`.
pub const reg_bg2cnt: *align(4) volatile u16 = @ptrFromInt(io_address + 0x000c);

/// REG_BG3CNT. See `gba.display.bg_ctrl` and, more specifically,
/// `gba.display.bg_ctrl[3]`.
pub const reg_bg3cnt: *volatile u16 = @ptrFromInt(io_address + 0x000e);

/// REG_BG_OFS. See `gba.display.bg_scroll`.
pub const reg_bg_ofs: *align(4) volatile [4][2]u16 = @ptrFromInt(io_address + 0x0010);

/// REG_BG0HOFS. See `gba.display.bg_scroll` and, more specifically,
/// `gba.display.bg_scroll[0].x`.
pub const reg_bg0hofs: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0010);

/// REG_BG0VOFS. See `gba.display.bg_scroll` and, more specifically,
/// `gba.display.bg_scroll[0].y`.
pub const reg_bg0vofs: *volatile u16 = @ptrFromInt(io_address + 0x0012);

/// REG_BG1HOFS. See `gba.display.bg_scroll` and, more specifically,
/// `gba.display.bg_scroll[1].x`.
pub const reg_bg1hofs: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0014);

/// REG_BG1VOFS. See `gba.display.bg_scroll` and, more specifically,
/// `gba.display.bg_scroll[1].y`.
pub const reg_bg1vofs: *volatile u16 = @ptrFromInt(io_address + 0x0016);

/// REG_BG2HOFS. See `gba.display.bg_scroll` and, more specifically,
/// `gba.display.bg_scroll[2].x`.
pub const reg_bg2hofs: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0018);

/// REG_BG2VOFS. See `gba.display.bg_scroll` and, more specifically,
/// `gba.display.bg_scroll[2].y`.
pub const reg_bg2vofs: *volatile u16 = @ptrFromInt(io_address + 0x001a);

/// REG_BG3HOFS. See `gba.display.bg_scroll` and, more specifically,
/// `gba.display.bg_scroll[3].x`.
pub const reg_bg3hofs: *align(4) volatile u16 = @ptrFromInt(io_address + 0x001c);

/// REG_BG3VOFS. See `gba.display.bg_scroll` and, more specifically,
/// `gba.display.bg_scroll[3].y`.
...
pub const reg_bg_affine: *align(4) volatile [2]RegBgAffine = @ptrFromInt(io_address + 0x0020);

/// REG_BG2PA. See `gba.display.bg_2_affine` and, more specifically,
/// `gba.display.bg_2_affine.abcd.a`.
pub const reg_bg2pa: *align(4) volatile i16 = @ptrFromInt(io_address + 0x0020);

/// REG_BG2PB. See `gba.display.bg_2_affine` and, more specifically,
/// `gba.display.bg_2_affine.abcd.b`.
pub const reg_bg2pb: *volatile i16 = @ptrFromInt(io_address + 0x0022);

/// REG_BG2PC. See `gba.display.bg_2_affine` and, more specifically,
/// `gba.display.bg_2_affine.abcd.c`.
pub const reg_bg2pc: *align(4) volatile i16 = @ptrFromInt(io_address + 0x0024);

/// REG_BG2PD. See `gba.display.bg_2_affine` and, more specifically,
/// `gba.display.bg_2_affine.abcd.d`.
pub const reg_bg2pd: *volatile i16 = @ptrFromInt(io_address + 0x0026);

/// REG_BG2X. See `gba.display.bg_2_affine` and, more specifically,
/// `gba.display.bg_2_affine.disp.x`.
pub const reg_bg2x: *volatile i32 = @ptrFromInt(io_address + 0x0028);

/// REG_BG2Y. See `gba.display.bg_2_affine` and, more specifically,
/// `gba.display.bg_2_affine.disp.y`.
pub const reg_bg2y: *volatile i32 = @ptrFromInt(io_address + 0x002c);

/// REG_BG3PA. See `gba.display.bg_3_affine` and, more specifically,
/// `gba.display.bg_3_affine.abcd.a`.
pub const reg_bg3pa: *align(4) volatile i16 = @ptrFromInt(io_address + 0x0030);

/// REG_BG3PB. See `gba.display.bg_3_affine` and, more specifically,
/// `gba.display.bg_3_affine.abcd.b`.
pub const reg_bg3pb: *volatile i16 = @ptrFromInt(io_address + 0x0032);

/// REG_BG3PC. See `gba.display.bg_3_affine` and, more specifically,
/// `gba.display.bg_3_affine.abcd.c`.
pub const reg_bg3pc: *align(4) volatile i16 = @ptrFromInt(io_address + 0x0034);

/// REG_BG3PD. See `gba.display.bg_3_affine` and, more specifically,
/// `gba.display.bg_3_affine.abcd.d`.
pub const reg_bg3pd: *volatile i16 = @ptrFromInt(io_address + 0x0036);

/// REG_BG3X. See `gba.display.bg_3_affine` and, more specifically,
/// `gba.display.bg_3_affine.disp.x`.
pub const reg_bg3x: *volatile i32 = @ptrFromInt(io_address + 0x0038);

/// REG_BG3Y. See `gba.display.bg_3_affine` and, more specifically,
/// `gba.display.bg_3_affine.disp.y`.
pub const reg_bg3y: *volatile i32 = @ptrFromInt(io_address + 0x003c);

/// REG_WIN0H. See `gba.display.window` and, more specifically,
/// `gba.display.window.bounds_x[0]`.
pub const reg_win0h: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0040);

/// REG_WIN1H. See `gba.display.window` and, more specifically,
/// `gba.display.window.bounds_x[1]`.
pub const reg_win1h: *volatile u16 = @ptrFromInt(io_address + 0x0042);

/// REG_WIN0V. See `gba.display.window` and, more specifically,
/// `gba.display.window.bounds_y[0]`.
pub const reg_win0v: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0044);

/// REG_WIN1V. See `gba.display.window` and, more specifically,
/// `gba.display.window.bounds_y[1]`.
pub const reg_win1v: *volatile u16 = @ptrFromInt(io_address + 0x0046);

/// REG_WININ. See `gba.display.window.inner`.
pub const reg_winin: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0048);

/// REG_WINOUT. See `gba.display.window.other`.
pub const reg_winout: *volatile u16 = @ptrFromInt(io_address + 0x004a);

/// REG_WIN0R. See `gba.display.window` and, more specifically,
/// `gba.display.window.bounds_x[0].right`.
pub const reg_win0r: *align(4) volatile u8 = @ptrFromInt(io_address + 0x0040);

/// REG_WIN0L. See `gba.display.window` and, more specifically,
/// `gba.display.window.bounds_x[0].left`.
pub const reg_win0l: *volatile u8 = @ptrFromInt(io_address + 0x0041);

/// REG_WIN1R. See `gba.display.window` and, more specifically,
/// `gba.display.window.bounds_x[1].right`.
pub const reg_win1r: *align(2) volatile u8 = @ptrFromInt(io_address + 0x0042);

/// REG_WIN1L. See `gba.display.window` and, more specifically,
/// `gba.display.window.bounds_x[1].left`.
pub const reg_win1l: *volatile u8 = @ptrFromInt(io_address + 0x0043);

/// REG_WIN0B. See `gba.display.window` and, more specifically,
/// `gba.display.window.bounds_y[0].bottom`.
pub const reg_win0b: *align(4) volatile u8 = @ptrFromInt(io_address + 0x0044);

/// REG_WIN0T. See `gba.display.window` and, more specifically,
/// `gba.display.window.bounds_y[0].top`.
pub const reg_win0t: *volatile u8 = @ptrFromInt(io_address + 0x0045);

/// REG_WIN1B. See `gba.display.window` and, more specifically,
/// `gba.display.window.bounds_y[1].bottom`.
pub const reg_win1b: *align(2) volatile u8 = @ptrFromInt(io_address + 0x0046);

/// REG_WIN1T. See `gba.display.window` and, more specifically,
/// `gba.display.window.bounds_y[1].top`.
pub const reg_win1t: *volatile u8 = @ptrFromInt(io_address + 0x0047);

/// REG_WIN0CNT. See `gba.display.window.win0`.
pub const reg_win0cnt: *align(4) volatile u8 = @ptrFromInt(io_address + 0x0048);

/// REG_WIN1CNT. See `gba.display.window.win1`.
pub const reg_win1cnt: *volatile u8 = @ptrFromInt(io_address + 0x0049);

/// REG_WINOUTCNT. See `gba.display.window.outer`.
pub const reg_winoutcnt: *align(2) volatile u8 = @ptrFromInt(io_address + 0x004a);

/// REG_WINOBJCNT. See `gba.display.window.obj`.
...
pub const reg_bldcnt: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0050);
...
pub const reg_bldy: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0054);

/// REG_SND1SWEEP. See `gba.sound.pulse_1_sweep`.
pub const reg_snd1sweep: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0060);

/// REG_SND1CNT. See `gba.sound.pulse_1_ctrl`.
pub const reg_snd1cnt: *volatile u16 = @ptrFromInt(io_address + 0x0062);

/// REG_SND1FREQ. See `gba.sound.pulse_1_freq`.
pub const reg_snd1freq: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0064);

/// REG_SND2CNT. See `gba.sound.pulse_2_ctrl`.
pub const reg_snd2cnt: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0068);

/// REG_SND2FREQ. See `gba.sound.pulse_2_freq`.
pub const reg_snd2freq: *align(4) volatile u16 = @ptrFromInt(io_address + 0x006c);

/// REG_SND3SEL. See `gba.sound.wave_select`.
pub const reg_snd3sel: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0070);

/// REG_SND3CNT. See `gba.sound.wave_ctrl`.
pub const reg_snd3cnt: *volatile u16 = @ptrFromInt(io_address + 0x0072);

/// REG_SND3FREQ. See `gba.sound.wave_freq`.
pub const reg_snd3freq: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0074);

/// REG_SND4CNT. See `gba.sound.noise_ctrl`.
pub const reg_snd4cnt: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0078);

/// REG_SND4FREQ. See `gba.sound.noise_freq`.
pub const reg_snd4freq: *align(4) volatile u16 = @ptrFromInt(io_address + 0x007c);
...
pub const reg_snddmgcnt: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0080);
...
pub const reg_sndstat: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0084);

/// REG_SNDBIAS. See `gba.sound.bias`.
pub const reg_sndbias: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0088);

/// REG_WAVE_RAM. See `gba.sound.wave_ram`.
pub const reg_wave_ram: *align(4) volatile [4]u32 = @ptrFromInt(io_address + 0x0090);

/// REG_WAVE_RAM0. See `gba.sound.wave_ram` and, more specifically,
/// `gba.sound.wave_ram[0]`.
pub const reg_wave_ram0: *volatile u32 = @ptrFromInt(io_address + 0x0090);

/// REG_WAVE_RAM1. See `gba.sound.wave_ram` and, more specifically,
/// `gba.sound.wave_ram[1]`.
pub const reg_wave_ram1: *volatile u32 = @ptrFromInt(io_address + 0x0094);

/// REG_WAVE_RAM2. See `gba.sound.wave_ram` and, more specifically,
/// `gba.sound.wave_ram[2]`.
pub const reg_wave_ram2: *volatile u32 = @ptrFromInt(io_address + 0x0098);

/// REG_WAVE_RAM3. See `gba.sound.wave_ram` and, more specifically,
/// `gba.sound.wave_ram[3]`.
...
pub const reg_dma: *align(4) volatile [3]RegDma = @ptrFromInt(io_address + 0x00b0);

/// REG_DMA0SAD. See `gba.mem.dma` and, more specifically,
/// `gba.mem.dma[0].source`.
pub const reg_dma0sad: *volatile u32 = @ptrFromInt(io_address + 0x00b0);

/// REG_DMA0DAD. See `gba.mem.dma` and, more specifically,
/// `gba.mem.dma[0].dest`.
pub const reg_dma0dad: *volatile u32 = @ptrFromInt(io_address + 0x00b4);

/// REG_DMA0CNT. See `gba.mem.dma` and, more specifically,
/// see `gba.mem.dma[0].count` and `gba.mem.dma[0].ctrl`.
pub const reg_dma0cnt: *volatile u32 = @ptrFromInt(io_address + 0x00b8);

/// REG_DMA1SAD. See `gba.mem.dma` and, more specifically,
/// `gba.mem.dma[1].source`.
pub const reg_dma1sad: *volatile u32 = @ptrFromInt(io_address + 0x00bc);

/// REG_DMA1DAD. See `gba.mem.dma` and, more specifically,
/// `gba.mem.dma[1].dest`.
pub const reg_dma1dad: *volatile u32 = @ptrFromInt(io_address + 0x00c0);

/// REG_DMA1CNT. See `gba.mem.dma` and, more specifically,
/// see `gba.mem.dma[1].count` and `gba.mem.dma[1].ctrl`.
pub const reg_dma1cnt: *volatile u32 = @ptrFromInt(io_address + 0x00c4);

/// REG_DMA2SAD. See `gba.mem.dma` and, more specifically,
/// `gba.mem.dma[2].source`.
pub const reg_dma2sad: *volatile u32 = @ptrFromInt(io_address + 0x00c8);

/// REG_DMA2DAD. See `gba.mem.dma` and, more specifically,
/// `gba.mem.dma[2].dest`.
pub const reg_dma2dad: *volatile u32 = @ptrFromInt(io_address + 0x00cc);

/// REG_DMA2CNT. See `gba.mem.dma` and, more specifically,
/// see `gba.mem.dma[2].count` and `gba.mem.dma[2].ctrl`.
pub const reg_dma2cnt: *volatile u32 = @ptrFromInt(io_address + 0x00d0);

/// REG_DMA3SAD. See `gba.mem.dma` and, more specifically,
/// `gba.mem.dma[3].source`.
pub const reg_dma3sad: *volatile u32 = @ptrFromInt(io_address + 0x00d4);

/// REG_DMA3DAD. See `gba.mem.dma` and, more specifically,
/// `gba.mem.dma[3].dest`.
pub const reg_dma3dad: *volatile u32 = @ptrFromInt(io_address + 0x00d8);

/// REG_DMA3CNT. See `gba.mem.dma` and, more specifically,
/// see `gba.mem.dma[3].count` and `gba.mem.dma[3].ctrl`.
...
pub const reg_tm: *align(4) volatile [4]RegTm = @ptrFromInt(io_address + 0x0100);

/// REG_TM0D. See `gba.timers` and, more specifically,
/// `gba.timers[0].counter`.
pub const reg_tm0d: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0100);

/// REG_TM0CNT. See `gba.timers` and, more specifically,
/// `gba.timers[0].ctrl`.
pub const reg_tm0cnt: *volatile u16 = @ptrFromInt(io_address + 0x0102);

/// REG_TM1D. See `gba.timers` and, more specifically,
/// `gba.timers[1].counter`.
pub const reg_tm1d: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0104);

/// REG_TM1CNT. See `gba.timers` and, more specifically,
/// `gba.timers[1].ctrl`.
pub const reg_tm1cnt: *volatile u16 = @ptrFromInt(io_address + 0x0106);

/// REG_TM2D. See `gba.timers` and, more specifically,
/// `gba.timers[2].counter`.
pub const reg_tm2d: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0108);

/// REG_TM2CNT. See `gba.timers` and, more specifically,
/// `gba.timers[2].ctrl`.
pub const reg_tm2cnt: *volatile u16 = @ptrFromInt(io_address + 0x010a);

/// REG_TM3D. See `gba.timers` and, more specifically,
/// `gba.timers[3].counter`.
pub const reg_tm3d: *align(4) volatile u16 = @ptrFromInt(io_address + 0x010c);

/// REG_TM3CNT. See `gba.timers` and, more specifically,
/// `gba.timers[3].ctrl`.
pub const reg_tm3cnt: *volatile u16 = @ptrFromInt(io_address + 0x010e);

/// REG_SIOCNT
pub const reg_siocnt: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0128);
...
/// REG_SIOMULTI
pub const reg_siomulti: *align(4) volatile [4]u16 = @ptrFromInt(io_address + 0x0120);

/// REG_SIOMULTI0
pub const reg_siomulti0: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0120);

/// REG_SIOMULTI1
pub const reg_siomulti1: *volatile u16 = @ptrFromInt(io_address + 0x0122);

/// REG_SIOMULTI2
pub const reg_siomulti2: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0124);

/// REG_SIOMULTI3
pub const reg_siomulti3: *volatile u16 = @ptrFromInt(io_address + 0x0126);

/// REG_SIOMLT_RECV
pub const reg_siomlt_recv: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0120);

/// REG_SIOMLT_SEND
pub const reg_siomlt_send: *volatile u16 = @ptrFromInt(io_address + 0x012a);

/// REG_KEYINPUT. See `gba.input.state`.
pub const reg_keyinput: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0130);

/// REG_KEYCNT. See `gba.input.interrupt`.
pub const reg_keycnt: *volatile u16 = @ptrFromInt(io_address + 0x0132);

/// REG_RCNT
pub const reg_rcnt: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0134);

/// REG_JOYCNT
pub const reg_joycnt: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0140);
...
/// REG_JOYSTAT
pub const reg_joystat: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0158);

/// REG_IE. See `gba.interrupt.enable`.
pub const reg_ie: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0200);
...
pub const reg_waitcnt: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0204);

/// REG_IME. See `gba.interrupt.master`.
pub const reg_ime: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0208);

/// REG_PAUSE
pub const reg_pause: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0300);

/// REG_BLDMOD. (Alternate name for REG_BLDCNT.)
pub const reg_bldmod: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0050);
...
pub const reg_coley: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0054);
...
pub const reg_sound1cnt_l: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0060);
...
pub const reg_sound1cnt_x: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0064);

/// REG_SOUND2CNT_L (Alternate name for REG_SND2CNT in belogic and GBATEK)
pub const reg_sound2cnt_l: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0068);

/// REG_SOUND2CNT_H (Alternate name for REG_SND2FREQ in belogic and GBATEK)
pub const reg_sound2cnt_h: *align(4) volatile u16 = @ptrFromInt(io_address + 0x006c);
...
pub const reg_sound3cnt_l: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0070);
...
pub const reg_sound3cnt_x: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0074);

/// REG_SOUND4CNT_L (Alternate name for REG_SND4CNT in belogic and GBATEK)
pub const reg_sound4cnt_l: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0078);

/// REG_SOUND4CNT_H (Alternate name for REG_SND4FREQ in belogic and GBATEK)
pub const reg_sound4cnt_h: *align(4) volatile u16 = @ptrFromInt(io_address + 0x007c);
...
pub const reg_soundcnt_l: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0080);
...
pub const reg_soundcnt_x: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0084);

/// REG_SOUNDBIAS (Alternate name for REG_SNDBIAS in belogic and GBATEK)
pub const reg_soundbias: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0088);

/// REG_WAVE (Alternate name for REG_WAVE_RAM in belogic and GBATEK)
pub const reg_wave: *align(4) volatile [4]u32 = @ptrFromInt(io_address + 0x0090);
...
pub const reg_dma0cnt_l: *align(4) volatile u16 = @ptrFromInt(io_address + 0x00b8);
...
pub const reg_dma1cnt_l: *align(4) volatile u16 = @ptrFromInt(io_address + 0x00c4);
...
pub const reg_dma2cnt_l: *align(4) volatile u16 = @ptrFromInt(io_address + 0x00d0);
...
pub const reg_dma3cnt_l: *align(4) volatile u16 = @ptrFromInt(io_address + 0x00dc);
...
pub const reg_tm0cnt_l: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0100);
...
pub const reg_tm1cnt_l: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0104);
...
pub const reg_tm2cnt_l: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0108);
...
pub const reg_tm3cnt_l: *align(4) volatile u16 = @ptrFromInt(io_address + 0x010c);
...
pub const reg_keys: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0130);

/// REG_P1 (Alternate name for REG_KEYINPUT in belogic and GBATEK)
pub const reg_p1: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0130);
...
pub const reg_scd0: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0120);
...
pub const reg_scd2: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0124);
...
pub const reg_sccnt_l: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0128);
...
pub const reg_r: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0134);

/// REG_HS_CTRL (Alternate name for REG_JOYCNT in belogic and GBATEK)
pub const reg_hs_ctrl: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0140);
...
pub const reg_joyre_l: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0150);
...
pub const reg_joytr_l: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0154);
...
pub const reg_jstat: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0158);

/// REG_WSCNT (Alternate name for REG_WAITCNT in belogic and GBATEK)
pub const reg_wscnt: *align(4) volatile u16 = @ptrFromInt(io_address + 0x0204);

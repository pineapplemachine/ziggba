...
pub const bgAffineSetDisplay = @import("bios_math.zig").bgAffineSetDisplay;
pub const bgAffineSetDisplay2 = @import("bios_math.zig").bgAffineSetDisplay2;
pub const bgAffineSetDisplay3 = @import("bios_math.zig").bgAffineSetDisplay3;
pub const bgAffineSetOne = @import("bios_math.zig").bgAffineSetOne;
